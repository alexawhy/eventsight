@bookmarks.each do |bookmark|
  json.set! bookmark.event.id do
    json.bookmark_id bookmark.id
    json.user_id bookmark.user.id
    json.event_id bookmark.event.id
    json.extract! bookmark.event, :organizer_id, :category_id, :title, :description, :online, :venue, :capacity, :start_date, :start_time, :end_date, :end_time
